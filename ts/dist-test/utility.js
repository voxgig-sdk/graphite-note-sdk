...
function envOverride(m) {
    if ('TRUE' === process.env.GRAPHITE_NOTE_TEST_LIVE ||
        'TRUE' === process.env.GRAPHITE_NOTE_TEST_OVERRIDE) {
    ...
    m.GRAPHITE_NOTE_TEST_EXPLAIN = process.env.GRAPHITE_NOTE_TEST_EXPLAIN || m.GRAPHITE_NOTE_TEST_EXPLAIN;
    return m;
}

...
// GraphiteNote SDK utility type

class GraphiteNoteUtility
{
    ...
    public static function copy(GraphiteNoteUtility $src): GraphiteNoteUtility
    {
        $u = new GraphiteNoteUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

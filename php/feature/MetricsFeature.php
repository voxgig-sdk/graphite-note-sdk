...
// GraphiteNote SDK metrics feature
...
class GraphiteNoteMetricsFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _record(GraphiteNoteContext $ctx, bool $ok): void
    {

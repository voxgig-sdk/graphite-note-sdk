...
// GraphiteNote SDK telemetry feature
...
class GraphiteNoteTelemetryFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _close(GraphiteNoteContext $ctx, bool $ok): void
    {

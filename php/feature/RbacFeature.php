...
class GraphiteNoteRbacFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _required(GraphiteNoteContext $ctx): ?string
    {
    ...
    private function _reject(GraphiteNoteContext $ctx, string $required): void
    {
    ...
    private function _track(GraphiteNoteContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
// GraphiteNote SDK cache feature
...
class GraphiteNoteCacheFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _through(GraphiteNoteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// GraphiteNote SDK netsim feature
...
class GraphiteNoteNetsimFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _simulate(GraphiteNoteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GraphiteNoteContext $ctx, array $applied): void
    {
        $client = $this->client;

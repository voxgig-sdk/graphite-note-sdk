...
// GraphiteNote SDK timeout feature
...
class GraphiteNoteTimeoutFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _with_timeout(GraphiteNoteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GraphiteNoteContext $_ctx, float $ms): void
    {
        $client = $this->client;

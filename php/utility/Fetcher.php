...
// GraphiteNote SDK utility: fetcher

class GraphiteNoteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GraphiteNoteSDK/1.0)';
    ...
    public static function call(GraphiteNoteContext $ctx, string $fullurl, array $fetchdef): array
    {

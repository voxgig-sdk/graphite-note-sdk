...
// GraphiteNote SDK Prediction entity
...
class PredictionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PredictionEntity($this->_client, $opts);
    }

    /**
     * @param Prediction|array $args Prediction data (assoc-array) to store.
     */
    ...
    /**
     * @return Prediction|array The current Prediction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Prediction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Prediction fields).
     */
     ...
     *
     * @param PredictionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PredictionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Prediction|array The created Prediction as an assoc-array at the

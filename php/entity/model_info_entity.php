...
// GraphiteNote SDK ModelInfo entity
...
class ModelInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ModelInfoEntity($this->_client, $opts);
    }

    /**
     * @param ModelInfo|array $args ModelInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return ModelInfo|array The current ModelInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ModelInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ModelInfo fields).
     */
    ...
    /**
     * Load a single ModelInfo.
     *
     * @param ModelInfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ModelInfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ModelInfo|array The loaded ModelInfo as an assoc-array at the

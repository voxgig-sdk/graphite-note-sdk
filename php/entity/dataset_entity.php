...
// GraphiteNote SDK Dataset entity
...
class DatasetEntity
{
     ...
     *
     * @param DatasetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DatasetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dataset|array The created Dataset as an assoc-array at the

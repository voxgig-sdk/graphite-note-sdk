...
// GraphiteNote SDK DatasetFill entity
...
class DatasetFillEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DatasetFillEntity($this->_client, $opts);
    }

    /**
     * @param DatasetFill|array $args DatasetFill data (assoc-array) to store.
     */
    ...
    /**
     * @return DatasetFill|array The current DatasetFill data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DatasetFill fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DatasetFill fields).
     */
    ...
    /**
     * Create a new DatasetFill.
     *
     * @param DatasetFillCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DatasetFillCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DatasetFill|array The created DatasetFill as an assoc-array at the

...
class ModelInfoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GRAPHITENOTE_TEST_MODEL_INFO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function model_info_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GRAPHITENOTE_TEST_MODEL_INFO_ENTID");

...
// GraphiteNote SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GraphiteNoteSDK::test)
...
{
    private const SDK_CLASS = 'GraphiteNoteSDK';
    ...
    private const SDK_BASE = 'graphitenote_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../graphitenote_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

...
class PredictionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GRAPHITENOTE_TEST_PREDICTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function prediction_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GRAPHITENOTE_TEST_PREDICTION_ENTID");

...
function runner.env_override(m)
  local live = runner.getenv("GRAPHITE_NOTE_TEST_LIVE")
  local override = runner.getenv("GRAPHITE_NOTE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GRAPHITE_NOTE_TEST_EXPLAIN")

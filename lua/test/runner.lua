...
function runner.env_override(m)
  local live = runner.getenv("GRAPHITENOTE_TEST_LIVE")
  local override = runner.getenv("GRAPHITENOTE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GRAPHITENOTE_TEST_EXPLAIN")

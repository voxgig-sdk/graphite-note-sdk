...
class ModelInfoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GRAPHITE_NOTE_TEST_MODEL_INFO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def model_info_basic_setup(extra)
  ...
  entid_env_raw = ENV["GRAPHITE_NOTE_TEST_MODEL_INFO_ENTID"]

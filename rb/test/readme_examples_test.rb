...
#      offline in seeded test mode (GraphiteNoteSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GraphiteNote_sdk.rb")
  SDK_CLASS = "GraphiteNoteSDK"

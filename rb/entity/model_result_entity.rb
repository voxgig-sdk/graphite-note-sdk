...
class ModelResultEntity
  ...
  def make
    opts = @_entopts.dup
    ModelResultEntity.new(@_client, opts)
  end
  ...
  # @return [ModelResult, Hash] the current ModelResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ModelResult fields)
  def match_get
  ...
  #
  # @param reqdata [ModelResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ModelResult, Hash] the created ModelResult; raises GraphiteNoteError on failure

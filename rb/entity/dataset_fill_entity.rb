...
class DatasetFillEntity
  ...
  def make
    opts = @_entopts.dup
    DatasetFillEntity.new(@_client, opts)
  end
  ...
  # @return [DatasetFill, Hash] the current DatasetFill data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DatasetFill fields)
  def match_get
  ...
  #
  # @param reqdata [DatasetFillCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DatasetFill, Hash] the created DatasetFill; raises GraphiteNoteError on failure

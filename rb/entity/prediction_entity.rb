...
class PredictionEntity
  ...
  def make
    opts = @_entopts.dup
    PredictionEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqdata [PredictionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Prediction, Hash] the created Prediction; raises GraphiteNoteError on failure

...
const testSeed = `map[string]any{"entity": map[string]any{"dataset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dataset_fill": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "model_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "model_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "prediction": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

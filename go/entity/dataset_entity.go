...
func NewDatasetEntity(client *core.GraphiteNoteSDK, entopts map[string]any) *DatasetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DatasetEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *DatasetEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DatasetCreateData and returns an Dataset. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DatasetEntity) CreateTyped(reqdata DatasetCreateData, ctrl map[string]any) (Dataset, error) {

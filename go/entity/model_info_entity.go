...
func NewModelInfoEntity(client *core.GraphiteNoteSDK, entopts map[string]any) *ModelInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ModelInfoEntity) GetName() string { return e.name }
...
func (e *ModelInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ModelInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *ModelInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewModelInfoEntity(e.client, opts)
}

func (e *ModelInfoEntity) Data(args ...any) any {
...
func (e *ModelInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ModelInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ModelInfoEntity) DataTyped(data ...ModelInfo) ModelInfo {
	if len(data) > 0 {
		return typedFrom[ModelInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[ModelInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ModelInfo (all fields
// optional at the wire level).
func (e *ModelInfoEntity) MatchTyped(match ...ModelInfo) ModelInfo {
	if len(match) > 0 {
		return typedFrom[ModelInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[ModelInfo](e.Match())
}
...
func (e *ModelInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ModelInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ModelInfoLoadMatch and returns an ModelInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ModelInfoEntity) LoadTyped(reqmatch ModelInfoLoadMatch, ctrl map[string]any) (ModelInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ModelInfo{}, err
	}
	return typedFrom[ModelInfo](res), nil
}



func (e *ModelInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ModelInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ModelInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ModelInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ModelInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

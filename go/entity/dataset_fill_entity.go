...
func NewDatasetFillEntity(client *core.GraphiteNoteSDK, entopts map[string]any) *DatasetFillEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DatasetFillEntity) GetName() string { return e.name }
...
func (e *DatasetFillEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DatasetFillEntity) Deleted() bool {
	return e.deleted
}


func (e *DatasetFillEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDatasetFillEntity(e.client, opts)
}

func (e *DatasetFillEntity) Data(args ...any) any {
...
func (e *DatasetFillEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DatasetFill; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DatasetFillEntity) DataTyped(data ...DatasetFill) DatasetFill {
	if len(data) > 0 {
		return typedFrom[DatasetFill](e.Data(asMap(data[0])))
	}
	return typedFrom[DatasetFill](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DatasetFill (all fields
// optional at the wire level).
func (e *DatasetFillEntity) MatchTyped(match ...DatasetFill) DatasetFill {
	if len(match) > 0 {
		return typedFrom[DatasetFill](e.Match(asMap(match[0])))
	}
	return typedFrom[DatasetFill](e.Match())
}
...
func (e *DatasetFillEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DatasetFillEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DatasetFillEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DatasetFillEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DatasetFillCreateData and returns an DatasetFill. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DatasetFillEntity) CreateTyped(reqdata DatasetFillCreateData, ctrl map[string]any) (DatasetFill, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DatasetFill{}, err
	}
	return typedFrom[DatasetFill](res), nil
}



func (e *DatasetFillEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DatasetFillEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DatasetFillEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewPredictionEntity(client *core.GraphiteNoteSDK, entopts map[string]any) *PredictionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PredictionEntity) GetName() string { return e.name }
...
func (e *PredictionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PredictionEntity) Deleted() bool {
	return e.deleted
}


func (e *PredictionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPredictionEntity(e.client, opts)
}

func (e *PredictionEntity) Data(args ...any) any {
...
func (e *PredictionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PredictionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PredictionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PredictionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PredictionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PredictionCreateData and returns an Prediction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PredictionEntity) CreateTyped(reqdata PredictionCreateData, ctrl map[string]any) (Prediction, error) {
...
func (e *PredictionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PredictionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PredictionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

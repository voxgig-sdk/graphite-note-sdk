...
func NewModelResultEntity(client *core.GraphiteNoteSDK, entopts map[string]any) *ModelResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ModelResultEntity) GetName() string { return e.name }
...
func (e *ModelResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ModelResultEntity) Deleted() bool {
	return e.deleted
}


func (e *ModelResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewModelResultEntity(e.client, opts)
}

func (e *ModelResultEntity) Data(args ...any) any {
...
func (e *ModelResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ModelResult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ModelResultEntity) DataTyped(data ...ModelResult) ModelResult {
	if len(data) > 0 {
		return typedFrom[ModelResult](e.Data(asMap(data[0])))
	}
	return typedFrom[ModelResult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ModelResult (all fields
// optional at the wire level).
func (e *ModelResultEntity) MatchTyped(match ...ModelResult) ModelResult {
	if len(match) > 0 {
		return typedFrom[ModelResult](e.Match(asMap(match[0])))
	}
	return typedFrom[ModelResult](e.Match())
}
...
func (e *ModelResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ModelResultEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ModelResultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ModelResultEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ModelResultCreateData and returns an ModelResult. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ModelResultEntity) CreateTyped(reqdata ModelResultCreateData, ctrl map[string]any) (ModelResult, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ModelResult{}, err
	}
	return typedFrom[ModelResult](res), nil
}



func (e *ModelResultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ModelResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ModelResultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

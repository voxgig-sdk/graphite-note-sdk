...
func registerSDKWords(r *eng.Registry, client *sdk.GraphiteNoteSDK) {
...
func runOp(client *sdk.GraphiteNoteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
|---|---|---|
| `ts/` | @voxgig-sdk/graphite-note | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/graphite-note \
      --repository voxgig-sdk/graphite-note-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/graphite-note` shows it, and
`npm trust revoke @voxgig-sdk/graphite-note --id=<id>` removes it.

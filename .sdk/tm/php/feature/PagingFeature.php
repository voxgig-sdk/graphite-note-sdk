...
// GraphiteNote SDK paging feature
...
class GraphiteNotePagingFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _graphql_pre_request(GraphiteNoteContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(GraphiteNoteContext $ctx): bool
    {

...
// GraphiteNote SDK audit feature
...
class GraphiteNoteAuditFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _emit(GraphiteNoteContext $ctx, string $outcome): void
    {

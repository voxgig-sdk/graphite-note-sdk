...
// GraphiteNote SDK streaming feature
...
class GraphiteNoteStreamingFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _iterate(GraphiteNoteResult $result): \Generator
    {
    ...
    private function _streamable(GraphiteNoteContext $ctx): bool
    {

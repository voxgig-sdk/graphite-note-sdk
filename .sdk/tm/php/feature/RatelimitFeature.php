...
// GraphiteNote SDK ratelimit feature
...
class GraphiteNoteRatelimitFeature extends GraphiteNoteBaseFeature
{
    ...
    private function _acquire(GraphiteNoteContext $ctx): void
    {
    ...
    private function _track(GraphiteNoteContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

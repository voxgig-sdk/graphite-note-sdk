...
// GraphiteNote SDK clienttrack feature
...
class GraphiteNoteClienttrackFeature extends GraphiteNoteBaseFeature
{
    ...
    public function PostConstruct(GraphiteNoteContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GraphiteNote-SDK';

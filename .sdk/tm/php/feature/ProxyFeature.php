...
// GraphiteNote SDK proxy feature
...
class GraphiteNoteProxyFeature extends GraphiteNoteBaseFeature
{
    ...
    public function init(GraphiteNoteContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GraphiteNoteContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

...
// GraphiteNote SDK utility: graphql
//
...
class GraphiteNoteGraphql
{
    ...
    // equivalent.
    public static function body(GraphiteNoteContext $ctx): mixed
    {
    ...
    public static function errors(GraphiteNoteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

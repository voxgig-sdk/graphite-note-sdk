...
class GraphiteNoteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GraphiteNoteTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GraphiteNoteTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GraphiteNoteTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

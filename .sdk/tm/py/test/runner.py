...
class GraphiteNoteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GraphiteNoteTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GraphiteNoteTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GraphiteNoteTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

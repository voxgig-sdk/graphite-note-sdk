...
from projectname_sdk.core.control import GraphiteNoteControl
...
class GraphiteNoteContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, GraphiteNoteSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GraphiteNoteResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GraphiteNoteResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GraphiteNoteError(code, msg, self)

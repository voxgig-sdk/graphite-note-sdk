...
class DatasetFillEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DatasetFillEntity(self._client, opts)
    ...
    def match_get(self) -> DatasetFill:
    ...
    def create(self, reqdata: DatasetFillCreateData, ctrl=None) -> DatasetFill:
        utility = self._utility

...
from graphitenote_sdk.graphitenote_types import (
    ModelResult,
...
class ModelResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ModelResultEntity(self._client, opts)
    ...
    def match_get(self) -> ModelResult:
    ...
    def create(self, reqdata: ModelResultCreateData, ctrl=None) -> ModelResult:
        utility = self._utility

...
class PredictionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PredictionEntity(self._client, opts)
    ...
    def create(self, reqdata: PredictionCreateData, ctrl=None) -> Prediction:
        utility = self._utility

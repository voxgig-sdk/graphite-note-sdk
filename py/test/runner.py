...
class GraphiteNoteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GraphiteNoteTestRunner.getenv("GRAPHITENOTE_TEST_LIVE")
        override = GraphiteNoteTestRunner.getenv("GRAPHITENOTE_TEST_OVERRIDE")
        ...
        explain = GraphiteNoteTestRunner.getenv("GRAPHITENOTE_TEST_EXPLAIN")

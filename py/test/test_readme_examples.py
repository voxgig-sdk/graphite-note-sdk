# GraphiteNote SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GraphiteNoteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GraphiteNoteSDK(...) and GraphiteNoteSDK.test(...) become
#      GraphiteNoteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "graphitenote_sdk"
_SDK_CLASS = "GraphiteNoteSDK"
